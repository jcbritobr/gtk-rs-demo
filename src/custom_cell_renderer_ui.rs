...
use glib::{Continue, IsA, ToValue};
use gtk::prelude::{
    CellLayoutExt, CellRendererToggleExt, ContainerExt, GtkListStoreExt, GtkListStoreExtManual,
    ScrolledWindowExt, TreeModelExt, TreeViewColumnExt, TreeViewExt, WidgetExt,
};
...
impl CustomCellRendererBox {
    pub fn new() -> Self {
        ...
        let label = gtk::Label::new(Some(
            "This is the new bug list (note: not based on real data, it would be \
